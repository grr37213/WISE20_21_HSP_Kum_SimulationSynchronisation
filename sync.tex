...
\end{itemize}
Ein konkretes Syncable definiert Serialisierungs- und Deserialisierungsmethoden für beide Kategorien von zu Datenpaketen statt. Für Pakete wird die Programmbibliothek SFML (siehe Quelle~\ref{sfml}), genauer deren Netzwerkkomponente, verwendet, welche eine plattformunabhängige Implementierung eines Datenpaket mitbringt, z.B. im Kontext Endianess.\\
